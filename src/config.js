...
export const config = {
  ...
  topK: toInt(process.env.TOP_K, 3),
  maxContextChars: toInt(process.env.MAX_CONTEXT_CHARS, 3500),
  maxChunkChars: toInt(process.env.MAX_CHUNK_CHARS, 1200),
  maxOutputTokens: toInt(process.env.MAX_OUTPUT_TOKENS, 350),
